...
<div class="jumbotron jumbotron-fluid bg-dark">
  ...
  <div class="">
    ...
    <form method="GETT" enc-type="multipart/form-data">
    <div class="form-group">
      ...
      <br><br><br>
      <h6>If you are finding any bugs please upload them here<a href="/uploadbug">Click Here</a> to upload</h6>
    </div>
  </form>
  </div>
  </div>
...
<?php echo $__env->make('navbarsbootsdtrap', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\sharath\manilara\resources\views/aboutus.blade.php ENDPATH**/ ?>